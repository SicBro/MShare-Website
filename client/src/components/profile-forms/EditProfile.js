...
const EditProfile = ({
  ...
  return (
    <Fragment>
      ...
      <p className="lead">
        <i className="fas fa-user"></i> So you want to update your profile? Add
        your changes and make it pop!
      </p>
      ...
      <form className="form" onSubmit={(e) => onSubmit(e)}>
        <div className="form-group">
          <select name="status" value={status} onChange={(e) => onChange(e)}>
            ...
            <option value="Sound Design Specialist">
        ...
        <div className="form-group">
          ...
          />
          <small className="form-text">
            Please use comma separated values (eg. Ruby,Unity,JavaScript,FL
            Studio)
          </small>
        </div>
        <div className="form-group">
